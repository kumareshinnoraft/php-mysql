...
/**
 * @extends ServiceEntityRepository<ValidateEmail>
 *
...
class ValidateEmailRepository extends ServiceEntityRepository
{
    ...
    public function save(ValidateEmail $entity, bool $flush = false): void
    {
    ...
    public function remove(ValidateEmail $entity, bool $flush = false): void
    {
